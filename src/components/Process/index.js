...
const Process = () => {
  console.log('Process')
  return (
    <div id="processSection" className="process-cont">
      <h1 className="pro-heading">OUR CREATIVE VIDEO PRODUCTION PROCESS</h1>
      <div className="line-arrow-dot-pr">
        <p className="dot-pr"> </p>
        <hr className="line-pr" />
      </div>
      <ul className="process-list-cont">
        <li className="list-item">
          <h1 className="list-item-heading">Scripting and Story boarding:</h1>
        ...
        <li className="list-item">
          <h1 className="list-item-heading">Pre-production and Shoot:</h1>
          <p className="list-des">
        ...
        <li className="list-item">
          <h1 className="list-item-heading">Post production: </h1>
          <p className="list-des">
            ...
            transform your raw footage into a polished masterpiece.
          </p>
        </li>
      </ul>
    </div>
